...
?>
	<div class="form-group row" id="facturas_pendientes">
	    <div class="col-xl-12">
          <div class="card">
            <div class="card-header border-0">
              <div class="row align-items-center">
                <div class="col">
                  <h3 class="mb-0">Facturas Pendiente de Pago</h3>
                </div>
            </div>
            <div class="table-responsive">
				<?php echo $factura->facturas_pendientes();?>              
            </div>
          </div>
        </div>
      </div>
	...
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			<div class="modal-header">
				<h5 class="modal-title" id="event-title">Pagar Factura Pendiente</h5>
...
<script>
	...
	function abre_detalles_pago(idc,idf){
		...
		$("#ver_pago").attr("src","../../view/facturas/facturas-pago.php?idc="+idc+"&idf="+idf);
