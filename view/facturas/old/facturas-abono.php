...
?>
  <form method="post" id="frmfacturas" action="../../controller/facturas.controller.php" enctype="multipart/form-data">
	...
	<div class="form-group row" id="div_ventas"></div>     
	<div class="form-group row">   
...
function validar(){
	var ident = $('input:checkbox[name=ventach]:checked').val();		
	...
	if(cliente==0){		
		 ...
		 return false;
	 }else if($("#val_factura").val() > $("#monto_pendi"+ident).val()){
