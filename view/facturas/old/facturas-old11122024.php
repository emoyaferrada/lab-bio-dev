...
?>
  ...
  <form  method="post" id="frmfacturas" action="../controller/facturas.controller.php">
    <h5>DATOS ANALISIS A FACTURAR</h5>
	...
	<div class="form-group row">   
	  ...
	  <div class="col">
        <label for="Numero Orden de Compra" class="col-form-label"><b>Numero Orden de Compra</b></label> 
        <input type="text" class="form-control" name="num_orden" id="num_orden">
      </div>
	  <div class="col">
        <label for="Fecha Orden de Compra" class="col-form-label"><b>Fecha Orden Compra</b></label> 
	...
	<div class="form-group row"> 
	  ...
	  <div class="col">
        ...
        <input type="text" class="form-control" id="num_cuota" name="num_cuota">        
      </div>
      <div class="col">
        <label for="Valor Abono"><b>Valor Abono</b></label> 
        <input type="text" class="form-control" id="valor_abono" name="valor_abono">        
      </div>
	  <div class="col">
        <label for="numero_cuotas"><b>Valor cuota</b></label> 
	...
	<div class="form-group row">
      <div class="offset-4 col-8">
        <button name="guardar_factura" id="guardar_factura" value="1" onClick="validar();" type="button" class="btn btn-primary">Guardar</button>
      </div>    
    </div>
  </form>
</div>
    ...
    $( document ).ready(function() {	
		$('#tipo_pago').on('click', function(){
			...
			if(num_cuota != "" && num_cuota != 0 ){				
				...
				$("#info_cuota").html(cuota+'PAGADO<input type="hidden" name="valor_cuota" value="'+cuota+'"><input type="hidden" name="pagada" value="1">');	
			}else{
				$("#info_cuota").html(cuota+'PENDIENTE<input type="hidden" name="valor_cuota" value="'+cuota+'"><input type="hidden" name="pagada" value="0">');		
			}
		})
