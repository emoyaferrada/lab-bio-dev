<?
  ...
  $registro_planificacion=$planificacion->obtiene_datos_id($id_programacion);
  $registro_detalle_planificacion=$planificacion->obtiene_datos_detalle($id_programacion);
    ...
    <div class="form-group row">
      ...
      <div class="col">
        ...
        <select id="resp_muestra" name="resp_muestra" class="custom-select"> 
          <option value="0">1. Propietario</option>
          <option value="1">2. LB-TRACK</option>
          <option value="2">3. Tercero</option>
        </select>    
	  </div>
      <div class="col">
...
$( document ).ready(function(){
   ...
   var registro_planificacion=<?echo json_encode($registro_planificacion);?>;
   var detalle_planificacion=<?echo json_encode($registro_detalle_planificacion);?>;
   valida_formulario(registro_planificacion,detalle_planificacion);
  ...
  $('#agregaranalisis').click(function() {
    var detalleDatos;
    console.log($('#usuario_toma_muestra').val());

    if  ($('#usuario_toma_muestra').val() == 0) {
  ...
  function valida_formulario(registro_planificacion,registro_detalle_planificacion){
    //modificar los select de cliente,predio y zona y dejarlos readonly
    //completar la tabla de detalle de analisis para guardar/modificar cambios
    console.log("VALIDA FORMULARIO",registro_planificacion);
    $('#cliente_id option[value="'+registro_planificacion.cliente_id+'"]').attr("selected", "selected");
    $('#cliente_id').attr("disabled", true);
    
    /*
    $('#cliente_id option[value="3"]').attr("selected", "selected");
    $('#predio_cliente_id option[value="3"]').attr("selected", "selected");
    $('#zona option[value="3"]').attr("selected", "selected");
    */
