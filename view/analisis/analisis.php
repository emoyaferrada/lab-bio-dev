...
<ul class="nav nav-pills nav-fill" id="myTab" role="tablist">
  <li class="nav-item">
    <a class="nav-link active" id="home-tab" data-toggle="tab" href="#home" role="tab" aria-controls="home" aria-selected="false">Ingresados</a>
  </li>
  <li class="nav-item">
  ...
  <li class="nav-item">
    <a class="nav-link" id="profile-tab" data-toggle="tab" href="#profile" role="tab" aria-controls="profile" aria-selected="false">Por Revisar</a>
  </li>
  <li class="nav-item">
    <a class="nav-link" id="contact2-tab" data-toggle="tab" href="#contact2" role="tab" aria-controls="contact2" aria-selected="false">Enviados</a>
  </li>    
  <li class="nav-item">
    <a class="nav-link" id="contact3-tab" data-toggle="tab" href="#contact3" role="tab" aria-controls="contact3" aria-selected="false">Rechazados</a>
  </li>  
</ul>
</div>
<!-- Tabla de analisis -->
        ...
        <div class="col-xl-12">
          <div class="card">
            ...
            <div class="table-responsive">
              <!-- Projects table -->
              <table class="table" id="estado_analisis">
...
<!-- Tabla de analisis por revisar -->
      <div class="tab-pane fade" id="profile" role="tabpanel" aria-labelledby="profile-tab">
        <div class="col-xl-12">
          ...
          <button type="button" id="hacer_reporte_solucion" name="hacer_reporte_solucion" value="1" class="btn btn-primary" data-toggle="modal" data-target="#nuevo_resultado_modal_solucion">Configurar Reporte Solución</button>
				</div>
            </form>
          </div>
        </div>
...
<!-- Tabla de analisis ingresados y rechazados -->
   ...
   <div class="tab-pane fade" id="contact3" role="tabpanel" aria-labelledby="contact3-tab">
    ...
    <!-- Modal resultado analisis solucion suelo -->
    <div class="modal fade" id="nuevo_resultado_modal_solucion" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
      <div class="modal-dialog modal-xl" role="document">
        <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="exampleModalLabel">Configurar reporte solución suelo</h5>
          <button type="button" class="close" data-dismiss="modal" aria-label="Cerrar">
              <span aria-hidden="true">&times;</span>
          </button>
        </div>
          <iframe src='../view/analisis/lab_bio_report/' frameborder="0" height="800" id="nuevo_resultado_solucion"></iframe>
        </div>
      </div>
    </div>
    <!-- Modal nuevo batch -->
  ...
  <script>
    $( document ).ready(function() {
        ...
        $('#estado_analisis').DataTable({
            ...
            { title: "Estado<br>" },
            { title: "Días<br> desde<br> Ingreso" }
            ]
        });
    ...
    $('#hacer_reporte_solucion').on('click', function(){
      //$("#contenido").printElement();
      var checked = []
      $("input[name='sel[]']:checked").each(function ()
      {
      ...
      $('#nuevo_resultado_solucion').attr('src','../view/analisis/reporte_solucion/index.php?sel='+sel);
